  ...
  return (
    <div>
      ...
      <div className="weather-info">
        ...
        <div className="col">
          <i className="fas fa-sun" style={{fontSize: '40px', color: '#ffa500'}}></i>
          <div>
            <p className="uv-index">{Math.floor(Math.random() * 11) + 1}</p>
            <p>UV Index</p>
          </div>
        </div>
        <div className="col">
          <i className="fas fa-thermometer-half" style={{fontSize: '40px', color: '#84cef5'}}></i>
          <div>
            <p className="feels-like">{renderTemperature(data.temperature.feels_like || data.temperature.current)}°</p>
            <p>Feels like</p>
          </div>
        </div>
      </div>
